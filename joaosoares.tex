...
\section{Links} 
%Skype:// \href{https://github.com/joaosr}{\bf joao-rembrandt} \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Experience}
\runsubsection{\href{http://ctic.ufpa.br/}{Terras}}
\descript{| Junior Software Development}
\location{Jul 2015 – Present | Belem, PA}
